...
gpt2_model = GPT2HeadWithValueModel.from_pretrained(config['model_name'], output_hidden_states=False)
...
total_ppo_epochs = int(np.ceil(config['step'] / config['batch_size']))
